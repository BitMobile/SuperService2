    ...
    public class Webactions : DbEntity
    {
        ...
        public static DbRef GetDbRefFromEnum(WebactionsEnum @enum)
        {
            ...
            switch (@enum)
            {
                ...
                case WebactionsEnum.EventsAllAvaliable:
                    ...
                    break;
                case WebactionsEnum.EventsShowSubordinate:
                    res = "0236eb9f-eed9-493b-9152-86b037e79a79";
                    break;
        ...
        public WebactionsEnum GetEnum() 
        {
            switch(Id.Guid.ToString())
            {
                ...
                case "0236eb9f-eed9-493b-9152-86b037e79a79": 
                    return WebactionsEnum.EventsShowSubordinate;
